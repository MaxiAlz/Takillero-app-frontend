...
const CreateEventForm = () => {
  ...
  const { eventData, isLoading, isError } = useGetEventById(+eventId!);
          ...
          <form onSubmit={handleSubmit} className="mx-10 ">
            ...
            <div className="my-5">
              ...
              <p className=" my-2">
                ...
                estacionamiento, opciones de accesibilidad o cualquier detalle
                que ayude a los asistentes a saber que habra en tu evento.
                (maximo 2500 caracteres)
              </p>
              <textarea
            ...
            <div className="flex w-full justify-end">
              <RoundedFilledButton
                text={
                  eventId ? 'Actualizar y Continuar' : 'Guardar y Continuar'
                }
                icon={
                  eventId ? (
